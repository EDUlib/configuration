...
##
CONFIGURATION_VERSION="edulib-juniper.master"
OPENEDX_RELEASE="edulib-juniper.master"
...
##
cd /var/tmp/configuration/playbooks && sudo -E ansible-playbook -vvvv -c local ./openedx_native.yml -i "localhost," $EXTRA_VARS "$@"
ansible_status=$?
